...
hlc.views.MainHud.prototype.onPlaylistHideStart = function( e ) {
	goog.dom.classlist.enable( this.playlistButtonContainerEl, 'flip', false );
...
hlc.views.MainHud.prototype.onClick = function( e ) {
	...
	switch ( e.currentTarget ) {
		case this.sidebarButton.domElement:
		...
		case this.playlistButton.domElement:
		...
		case this.playlistCloseButton.domElement:
			var hasClickedOnShape = tracker.getClickResult( e, true );
			if ( !hasClickedOnShape ) return false;
...
hlc.views.MainHud.prototype.onResize = function( e ) {
	...
	goog.style.setStyle( this.sidebarButtonEl, {
		'top': sidebarButtonDomY + 'px',
		'right': sidebarButtonDomSize.width + 'px'
	} );
